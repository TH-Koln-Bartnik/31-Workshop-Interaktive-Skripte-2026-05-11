...
Im Repository des Workshops liegt eine fertige `_brand.yml` mit der TH-Köln-Palette. Kopiere sie in Ihr Projektverzeichnis. Beim nächsten `quarto render` sind Links rot, Überschriften schwarz, Akzente magenta.
