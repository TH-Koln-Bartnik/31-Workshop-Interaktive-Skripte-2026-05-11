...
::: {.callout-tip}
## Lernspiel öffnen
[Lernspiel: Welches Prinzip steckt hinter welchem Beispiel? →](../assets/lernspiel-kapitel1.html){target="_blank"}
:::

::: {.callout-warning}
## Was, wenn …

- **Das Spiel öffnet sich nicht?** → Direkt im Browser über die Datei `assets/lernspiel-kapitel1.html` öffnen. Die Datei ist eine einzige HTML-Datei, ohne Backend.
