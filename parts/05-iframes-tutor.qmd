...
Schau dir das **Lernspiel aus Kapitel 1** ([assets/lernspiel-kapitel1.html](../assets/lernspiel-kapitel1.html){target="_blank"}) im Browser an. Öffne die Datei in einem Texteditor — sie ist eine einzige HTML-Datei, ohne Backend. Diesen Bauplan kannst du selbst (oder dein KI-Tutor) für ein eigenes Spiel im gewählten Strang nutzen.
