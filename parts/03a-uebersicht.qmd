...
- **Strang A — Wissenschaftliche Einstellung:** Bergstrom & West [-@bergstrom2024], dazu zwei eigene Ergänzungen.
- **Strang B — Recherche und Quellenqualität:** Bergstrom & West [-@bergstrom2024], dazu eine Quelle zu Open-Access-Datenbanken (z. B. <https://doaj.org>) und eine zu Pre-Print-Servern.
- **Strang C — Transparent schreiben:** Bergstrom & West [-@bergstrom2024], dazu eine Quelle zur TOP-Guideline-Initiative und eine zu Reproducible Research.
:::
